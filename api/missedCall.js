...
const AI_API_KEY = process.env.GOOGLE_AI_KEY; // Make sure this is set in Vercel

async function generateAIMessage(leadName, clinicName, messageType) {
  const prompt = `
Напиши кратко, учтиво и професионално SMS до пациент за пропуснато обаждане.
  ...
  try {
    ...
    switch (messages.length) {
      ...
      case 2:
        ...
        break;
      default:
        return res.json({ status: 'No more follow-up messages' });
    }
